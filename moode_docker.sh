...
podman volume create sys
podman create --name debian-moode --restart always -v moode:/mnt/NAS -v sys:/sys/:rw --network=host navikey/raspbian-bullseye /lib/systemd/systemd
